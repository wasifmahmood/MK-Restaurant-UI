        ...
        >
            ...
            sx={{ ...modalWrapStyle }}>
                <div className="modal-box  ">
                    ...
                    <div className="order-option d-flex pt-3 pr-5 pl-4 pb-2 "style={{columnGap:10}}>
                        <div className="delivery d-flex bg-danger rounded-pill px-3 ${isActive ? 'active' : 'inactive'}`}"
                        ...
                        <div className="pickup d-flex bg-danger rounded-pill px-3 ${isActive ? 'inactive' : 'active'}`}"
                            style={{ color: 'white',alignItems: "center" }}>
                            <div style={{ marginRight: "5px" }}>
                                <HiShoppingBag
                                    size={'20px'}
                    ...
                    <div className="footer row px-12 py-4 px-5 pb-5" style={{ alignItems: 'center' }}>
